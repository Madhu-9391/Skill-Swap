    ...
    <div className="flex fixed inset-0 overflow-hidden">
      ...
      >
        ...
        <div className="mt-6 bg-gradient-to-br from-blue-400 via-blue-500 to-indigo-600 rounded-3xl shadow-2xl p-8 w-[85%] max-w-md">
          ...
          {error && (
            <p className="text-red-500 font-semibold text-center mb-3">{error}</p>
          )}
          ...
          <form onSubmit={handleSubmit} autoComplete="off" className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-3 w-full rounded-full border border-gray-300 outline-none text-base text-gray-900 bg-gray-100 focus:bg-white focus:ring-2 focus:ring-blue-500"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-10 py-3 w-full rounded-full border border-gray-300 outline-none text-base text-gray-900 bg-gray-100 focus:bg-white focus:ring-2 focus:ring-blue-500"
              />
              <div
            ...
            <button
              type="submit"
              className="w-2/3 mx-auto block bg-blue-500 text-white font-semibold py-3 rounded-full hover:bg-blue-600 transition duration-300"
            >
              Register
            </button>
